...
## Summary
Podcast Brief Adaptation is the spoke for turn a post into an audio segment plan with source reminders and follow-up links.
...
The durable output is a podcast brief.
The success condition is that audio talking points keep dates, uncertainty, and source names audible.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Podcast Brief Adaptation.
...
- Metric set for review: segment flow, source mentions, host notes, and canonical show link.

## Operating Procedure
- Start with the precise decision that Podcast Brief Adaptation must make.
...
- Reject the failure pattern of making offhand claims that are stronger than the article.
...
## Acceptance Criteria
- The podcast brief names the exact object under review.
...
- The note accepts making offhand claims that are stronger than the article.
...
- The next review should verify whether segment flow, source mentions, host notes, and canonical show link still captures the decision quality.
