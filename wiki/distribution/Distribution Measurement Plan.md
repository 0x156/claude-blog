...
## Summary
Distribution Measurement Plan is the spoke for measure reach, clicks, engagement, citations, and owned audience actions by channel.
...
The durable output is a measurement plan.
The success condition is that reporting separates property data from market context and estimates.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Distribution Measurement Plan.
...
- Metric set for review: channel KPIs, data source, attribution caveat, and review cadence.

## Operating Procedure
- Start with the precise decision that Distribution Measurement Plan must make.
...
- Reject the failure pattern of declaring channel success from vanity metrics alone.
...
## Acceptance Criteria
- The measurement plan names the exact object under review.
...
- The note accepts declaring channel success from vanity metrics alone.
...
- The next review should verify whether channel KPIs, data source, attribution caveat, and review cadence still captures the decision quality.
