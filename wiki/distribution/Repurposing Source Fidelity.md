...
## Summary
Repurposing Source Fidelity is the spoke for preserve facts, dates, source context, and caveats as a blog post becomes channel assets.
...
The durable output is a source fidelity checklist.
The success condition is that every derivative asset keeps the original claim boundaries.
...
- Sibling comparison starts with [[Email Newsletter Adaptation]] and [[Social Thread Adaptation]].
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Repurposing Source Fidelity.
...
- Metric set for review: claim preservation, source visibility, date retention, and caveat retention.

## Operating Procedure
- Start with the precise decision that Repurposing Source Fidelity must make.
...
- Reject the failure pattern of shortening content until a qualified claim becomes misleading.
...
## Acceptance Criteria
- The source fidelity checklist names the exact object under review.
...
- The note accepts shortening content until a qualified claim becomes misleading.
- The note hides unresolved uncertainty instead of naming it.
- The note duplicates another sibling without a clear boundary.

## Handoff
- Send brief structure questions to [[Email Newsletter Adaptation]].
...
- The next review should verify whether claim preservation, source visibility, date retention, and caveat retention still captures the decision quality.
