...
## Summary
Community Post Adaptation is the spoke for adapt a post for communities with context, disclosure, and non-promotional utility.
...
The durable output is a community post draft.
The success condition is that the community version answers a local problem and links only when useful.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Community Post Adaptation.
...
- Metric set for review: question fit, disclosure, moderator risk, and discussion quality.

## Operating Procedure
- Start with the precise decision that Community Post Adaptation must make.
...
- Reject the failure pattern of posting a generic teaser that ignores community norms.
...
## Acceptance Criteria
- The community post draft names the exact object under review.
...
- The note accepts posting a generic teaser that ignores community norms.
...
- The next review should verify whether question fit, disclosure, moderator risk, and discussion quality still captures the decision quality.
