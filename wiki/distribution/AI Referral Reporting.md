...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs AI Referral Reporting.
...
- Metric set for review: AI referral sessions, GSC AI impressions, citation notes, and confidence label.

## Operating Procedure
- Start with the precise decision that AI Referral Reporting must make.
...
- Reject the failure pattern of mixing AI Overview citations, AI Mode impressions, and chatbot referrals into one metric.
...
## Acceptance Criteria
- The AI referral report names the exact object under review.
...
- The note accepts mixing AI Overview citations, AI Mode impressions, and chatbot referrals into one metric.
...
- The next review should verify whether AI referral sessions, GSC AI impressions, citation notes, and confidence label still captures the decision quality.
