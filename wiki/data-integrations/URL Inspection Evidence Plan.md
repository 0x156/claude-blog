...
## Summary
This spoke uses URL Inspection evidence to separate indexing status from content quality diagnosis.
...
Primary working inputs: URL list, canonical status, coverage data, rich result state.
...
## Workflow
- Define the decision this note supports: uses URL Inspection evidence to separate indexing status from content quality diagnosis.
...
## Risk Controls
- Evidence currency risk: URL Inspection Evidence Plan decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep URL Inspection Evidence Plan advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn URL Inspection Evidence Plan into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust URL Inspection Evidence Plan guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in URL Inspection Evidence Plan outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A URL Inspection Evidence Plan decision summary for the editor or auditor.
...
- A blocked-claims list for URL Inspection Evidence Plan gaps that need more evidence.
...
- A no-action statement when URL Inspection Evidence Plan evidence is incomplete or outside this brain.
