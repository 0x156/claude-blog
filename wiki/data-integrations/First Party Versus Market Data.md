...
## Summary
This spoke separates property data from market studies so reports do not overfit external averages.
...
Primary working inputs: GSC exports, GA4 reports, market benchmarks, source confidence.
...
## Workflow
- Define the decision this note supports: separates property data from market studies so reports do not overfit external averages.
