...
## Summary
This spoke records how AI Overview and AI Mode performance reporting should be used when available.
...
Primary working inputs: GSC access, AI feature report availability, page set, date range.
...
## Workflow
- Define the decision this note supports: records how AI Overview and AI Mode performance reporting should be used when available.
...
## Risk Controls
- Evidence currency risk: Generative AI Performance Reporting decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Generative AI Performance Reporting advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Generative AI Performance Reporting into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Generative AI Performance Reporting guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Generative AI Performance Reporting outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Generative AI Performance Reporting decision summary for the editor or auditor.
...
- A blocked-claims list for Generative AI Performance Reporting gaps that need more evidence.
...
- A no-action statement when Generative AI Performance Reporting evidence is incomplete or outside this brain.
