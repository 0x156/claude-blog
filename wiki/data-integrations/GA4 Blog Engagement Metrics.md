...
## Summary
This spoke maps GA4 engagement metrics to content review without replacing Search Console evidence.
...
Primary working inputs: landing page report, engagement rate, events, conversions.
...
## Workflow
- Define the decision this note supports: maps GA4 engagement metrics to content review without replacing Search Console evidence.
...
## Risk Controls
- Evidence currency risk: GA4 Blog Engagement Metrics decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep GA4 Blog Engagement Metrics advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn GA4 Blog Engagement Metrics into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust GA4 Blog Engagement Metrics guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in GA4 Blog Engagement Metrics outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A GA4 Blog Engagement Metrics decision summary for the editor or auditor.
...
- A blocked-claims list for GA4 Blog Engagement Metrics gaps that need more evidence.
...
- A no-action statement when GA4 Blog Engagement Metrics evidence is incomplete or outside this brain.
