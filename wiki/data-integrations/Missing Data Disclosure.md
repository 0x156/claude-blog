...
## Summary
This spoke gives writers approved language for absent GSC, GA4, URL Inspection, or AI feature reports.
...
Primary working inputs: missing source, reason, fallback source, caveat text.
...
## Workflow
- Define the decision this note supports: gives writers approved language for absent GSC, GA4, URL Inspection, or AI feature reports.
...
## Risk Controls
- Evidence currency risk: Missing Data Disclosure decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Missing Data Disclosure advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Missing Data Disclosure into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Missing Data Disclosure guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Missing Data Disclosure outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Missing Data Disclosure decision summary for the editor or auditor.
...
- A blocked-claims list for Missing Data Disclosure gaps that need more evidence.
...
- A no-action statement when Missing Data Disclosure evidence is incomplete or outside this brain.
