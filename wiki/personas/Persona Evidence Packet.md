...
## Summary
This spoke stores the evidence that makes a persona usable rather than imaginary.
...
Primary working inputs: interviews, support logs, sales notes, search data, survey excerpts.
...
## Workflow
- Define the decision this note supports: stores the evidence that makes a persona usable rather than imaginary.
...
## Risk Controls
- Evidence currency risk: Persona Evidence Packet decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Persona Evidence Packet advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Persona Evidence Packet into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Persona Evidence Packet guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Persona Evidence Packet outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Persona Evidence Packet decision summary for the editor or auditor.
...
- A blocked-claims list for Persona Evidence Packet gaps that need more evidence.
...
- A no-action statement when Persona Evidence Packet evidence is incomplete or outside this brain.
