...
## Summary
This spoke blocks guarantees, unsupported superlatives, unverifiable claims, and deprecated SEO advice.
...
Primary working inputs: claim inventory, source map, legal restrictions, editor flags.
...
## Workflow
- Define the decision this note supports: blocks guarantees, unsupported superlatives, unverifiable claims, and deprecated SEO advice.
...
## Risk Controls
- Evidence currency risk: Banned Claims And Phrases decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Banned Claims And Phrases advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Banned Claims And Phrases into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Banned Claims And Phrases guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Banned Claims And Phrases outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Banned Claims And Phrases decision summary for the editor or auditor.
...
- A blocked-claims list for Banned Claims And Phrases gaps that need more evidence.
...
- A no-action statement when Banned Claims And Phrases evidence is incomplete or outside this brain.
