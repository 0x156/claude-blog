...
## Summary
This spoke checks clarity, scanability, sentence load, heading structure, and answer-first writing.
...
Primary working inputs: draft markdown, target reader level, heading outline, examples.
...
## Workflow
- Define the decision this note supports: checks clarity, scanability, sentence load, heading structure, and answer-first writing.
...
## Risk Controls
- Evidence currency risk: Readability Review decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Readability Review advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Readability Review into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Readability Review guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Readability Review outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Readability Review decision summary for the editor or auditor.
...
- A blocked-claims list for Readability Review gaps that need more evidence.
...
- A no-action statement when Readability Review evidence is incomplete or outside this brain.
