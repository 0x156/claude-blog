...
## Summary
This spoke detects when drafts or clusters move away from approved voice, source discipline, or persona needs.
...
Primary working inputs: sample set, style inventory, banned claim list, editor notes.
...
## Workflow
- Define the decision this note supports: detects when drafts or clusters move away from approved voice, source discipline, or persona needs.
...
## Risk Controls
- Evidence currency risk: Voice Drift Audit decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Voice Drift Audit advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Voice Drift Audit into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Voice Drift Audit guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Voice Drift Audit outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Voice Drift Audit decision summary for the editor or auditor.
...
- A blocked-claims list for Voice Drift Audit gaps that need more evidence.
...
- A no-action statement when Voice Drift Audit evidence is incomplete or outside this brain.
