...
## Summary
This spoke keeps sensitive topics cautious, sourced, reviewer-led, and free from inflated certainty.
...
Primary working inputs: YMYL flag, expert reviewer, source quality, legal or medical constraints.
...
## Workflow
- Define the decision this note supports: keeps sensitive topics cautious, sourced, reviewer-led, and free from inflated certainty.
...
## Risk Controls
- Evidence currency risk: YMYL Tone Guardrails decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep YMYL Tone Guardrails advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn YMYL Tone Guardrails into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust YMYL Tone Guardrails guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in YMYL Tone Guardrails outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A YMYL Tone Guardrails decision summary for the editor or auditor.
...
- A blocked-claims list for YMYL Tone Guardrails gaps that need more evidence.
...
- A no-action statement when YMYL Tone Guardrails evidence is incomplete or outside this brain.
