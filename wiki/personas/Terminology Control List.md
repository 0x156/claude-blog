...
## Summary
This spoke keeps preferred terms, forbidden terms, synonyms, acronyms, and definitions consistent across the blog.
...
Primary working inputs: glossary, keyword set, style guide, product naming.
...
## Workflow
- Define the decision this note supports: keeps preferred terms, forbidden terms, synonyms, acronyms, and definitions consistent across the blog.
...
## Risk Controls
- Evidence currency risk: Terminology Control List decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Terminology Control List advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Terminology Control List into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Terminology Control List guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Terminology Control List outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Terminology Control List decision summary for the editor or auditor.
...
- A blocked-claims list for Terminology Control List gaps that need more evidence.
...
- A no-action statement when Terminology Control List evidence is incomplete or outside this brain.
