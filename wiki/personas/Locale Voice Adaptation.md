...
## Summary
This spoke preserves brand voice while adapting idiom, formality, and cultural references for a locale.
...
Primary working inputs: locale brief, brand traits, local reviewer notes, term list.
...
## Workflow
- Define the decision this note supports: preserves brand voice while adapting idiom, formality, and cultural references for a locale.
...
## Risk Controls
- Evidence currency risk: Locale Voice Adaptation decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Locale Voice Adaptation advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Locale Voice Adaptation into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Locale Voice Adaptation guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Locale Voice Adaptation outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Locale Voice Adaptation decision summary for the editor or auditor.
...
- A blocked-claims list for Locale Voice Adaptation gaps that need more evidence.
...
- A no-action statement when Locale Voice Adaptation evidence is incomplete or outside this brain.
