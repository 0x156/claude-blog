...
## Summary
This spoke records voice traits, examples, banned moves, and acceptable variation for writers and editors.
...
Primary working inputs: style samples, editorial notes, approved phrasing, brand glossary.
...
## Workflow
- Define the decision this note supports: records voice traits, examples, banned moves, and acceptable variation for writers and editors.
...
## Risk Controls
- Evidence currency risk: Brand Voice Inventory decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Brand Voice Inventory advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Brand Voice Inventory into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Brand Voice Inventory guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Brand Voice Inventory outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Brand Voice Inventory decision summary for the editor or auditor.
...
- A blocked-claims list for Brand Voice Inventory gaps that need more evidence.
...
- A no-action statement when Brand Voice Inventory evidence is incomplete or outside this brain.
