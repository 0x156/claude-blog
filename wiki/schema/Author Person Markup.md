...
## Summary
Author Person Markup is a schema review note for blog schema stack.
It connects visible author identity to Person markup and E-E-A-T evidence.
Use it with [[Blog Schema Stack]] when the working unit is a blog post, entity graph, or structured data block.

## Operating Question
- Does Person markup match the visible author and author page?
- The expected output is an author markup checklist with sameAs and profile cautions.
- The main risk is marking up a fictional or unsupported author identity.
...
## Specific Checks
- Check that author person markup is applied to the correct content unit.
- Check that the decision matches this purpose: connects visible author identity to Person markup and E-E-A-T evidence.
- Check that the output can be inspected as an author markup checklist with sameAs and profile cautions.
- Check that the risk is addressed directly: marking up a fictional or unsupported author identity.
