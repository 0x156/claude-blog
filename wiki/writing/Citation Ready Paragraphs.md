...
## Summary
Citation Ready Paragraphs is a drafting note for six-pillar writing.
It shapes important paragraphs so they can be extracted without losing meaning.
Use it with [[6-Pillar Dual Optimization]] when the working unit is a draft section, outline, or article.

## Operating Question
- Can this paragraph be understood if it appears outside the full article?
- The expected output is a revised paragraph with entity, date, constraint, and nearby source.
- The main risk is using pronouns, vague nouns, or unsupported superlatives in answer blocks.
...
## Specific Checks
- Check that citation ready paragraphs is applied to the correct content unit.
- Check that the decision matches this purpose: shapes important paragraphs so they can be extracted without losing meaning.
- Check that the output can be inspected as a revised paragraph with entity, date, constraint, and nearby source.
- Check that the risk is addressed directly: using pronouns, vague nouns, or unsupported superlatives in answer blocks.
