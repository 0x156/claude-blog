...
## Summary
Experience Signal Placement is a drafting note for six-pillar writing.
It places first-hand or operational evidence where it supports the claim.
Use it with [[6-Pillar Dual Optimization]] when the working unit is a draft section, outline, or article.

## Operating Question
- Where does the reader see proof that the author or brand has relevant experience?
- The expected output is a placement map for examples, screenshots, data, or field notes.
- The main risk is burying experience in an author bio while claims stay generic.
...
## Specific Checks
- Check that experience signal placement is applied to the correct content unit.
- Check that the decision matches this purpose: places first-hand or operational evidence where it supports the claim.
- Check that the output can be inspected as a placement map for examples, screenshots, data, or field notes.
- Check that the risk is addressed directly: burying experience in an author bio while claims stay generic.
