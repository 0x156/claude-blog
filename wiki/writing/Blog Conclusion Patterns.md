...
## Summary
Blog Conclusion Patterns is a drafting note for six-pillar writing.
It closes posts with decision support rather than generic recap.
Use it with [[6-Pillar Dual Optimization]] when the working unit is a draft section, outline, or article.

## Operating Question
- What should the reader decide, verify, or do after the article?
- The expected output is a conclusion pattern with next step, limitation, and internal link.
- The main risk is ending with a bland summary that adds no operational value.
...
## Specific Checks
- Check that blog conclusion patterns is applied to the correct content unit.
- Check that the decision matches this purpose: closes posts with decision support rather than generic recap.
- Check that the output can be inspected as a conclusion pattern with next step, limitation, and internal link.
- Check that the risk is addressed directly: ending with a bland summary that adds no operational value.
