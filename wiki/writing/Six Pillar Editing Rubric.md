...
## Summary
Six Pillar Editing Rubric is a drafting note for six-pillar writing.
It turns the six-pillar model into a scored editing pass.
Use it with [[6-Pillar Dual Optimization]] when the working unit is a draft section, outline, or article.

## Operating Question
- Which pillar is weak enough to block handoff?
- The expected output is a rubric score with fixes, confidence, and source gaps.
- The main risk is treating a high word count as proof of quality.
...
## Specific Checks
- Check that six pillar editing rubric is applied to the correct content unit.
- Check that the decision matches this purpose: turns the six-pillar model into a scored editing pass.
- Check that the output can be inspected as a rubric score with fixes, confidence, and source gaps.
- Check that the risk is addressed directly: treating a high word count as proof of quality.
