...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Evidence Block Requirements.
...
- Metric set for review: source coverage, date coverage, claim risk, and confidence label.

## Operating Procedure
- Start with the precise decision that Evidence Block Requirements must make.
...
- Reject the failure pattern of allowing unsupported statistics into a brief.
...
## Acceptance Criteria
- The evidence block checklist names the exact object under review.
...
- The note accepts allowing unsupported statistics into a brief.
...
- The next review should verify whether source coverage, date coverage, claim risk, and confidence label still captures the decision quality.
