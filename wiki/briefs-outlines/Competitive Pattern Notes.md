---
type: spoke
title: "Competitive Pattern Notes"
status: active
created: 2026-07-06
updated: 2026-07-06
...
## Summary
Competitive Pattern Notes is the spoke for record visible SERP patterns, source types, media formats, and gaps without copying competitors.
...
The durable output is a competitive pattern note.
The success condition is that briefs learn from the SERP while adding original value.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Competitive Pattern Notes.
...
- Metric set for review: pattern evidence, gap quality, originality plan, and citation opportunity.

## Operating Procedure
- Start with the precise decision that Competitive Pattern Notes must make.
...
- Reject the failure pattern of treating a competitor section list as a content template.
...
## Acceptance Criteria
- The competitive pattern note names the exact object under review.
...
- The note accepts treating a competitor section list as a content template.
...
- The next review should verify whether pattern evidence, gap quality, originality plan, and citation opportunity still captures the decision quality.
