...
## Summary
Reader Value Versus Extraction Value is a planning note for dual optimization.
It balances helpful reading flow with self-contained answer blocks for extraction.
Use it with [[Dual Optimization]] when the working unit is a blog program, article, or section.

## Operating Question
- Does the passage help a person first while remaining understandable out of context?
- The expected output is a balance note that protects reader value and extraction clarity.
- The main risk is turning an article into disconnected snippets.
...
## Specific Checks
- Check that reader value versus extraction value is applied to the correct content unit.
- Check that the decision matches this purpose: balances helpful reading flow with self-contained answer blocks for extraction.
- Check that the output can be inspected as a balance note that protects reader value and extraction clarity.
- Check that the risk is addressed directly: turning an article into disconnected snippets.
