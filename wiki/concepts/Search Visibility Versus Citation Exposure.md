...
## Summary
Search Visibility Versus Citation Exposure is a planning note for dual optimization.
It separates rankings and clicks from AI answer exposure so reporting does not collapse different outcomes.
Use it with [[Dual Optimization]] when the working unit is a blog program, article, or section.

## Operating Question
- Which outcome is being planned: visibility, click, citation, or assisted conversion?
- The expected output is a metric split with source dates, caveats, and next measurement action.
- The main risk is reporting a citation win as if it were the same as organic traffic.
...
## Specific Checks
- Check that search visibility versus citation exposure is applied to the correct content unit.
- Check that the decision matches this purpose: separates rankings and clicks from AI answer exposure so reporting does not collapse different outcomes.
- Check that the output can be inspected as a metric split with source dates, caveats, and next measurement action.
- Check that the risk is addressed directly: reporting a citation win as if it were the same as organic traffic.
...
- Use [[Zero Click Planning Baseline]] when this note needs a sibling follow-up.
- Use [[AI Overview CTR Interpretation]] when the next decision belongs beside this note.
