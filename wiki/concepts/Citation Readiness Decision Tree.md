...
## Summary
Citation Readiness Decision Tree is a planning note for dual optimization.
It decides which passages deserve GEO work before drafting or rewriting starts.
Use it with [[Dual Optimization]] when the working unit is a blog program, article, or section.

## Operating Question
- Which section is worth making citation-ready and why?
- The expected output is a yes, no, or defer decision with evidence requirements.
- The main risk is applying citation formatting to every paragraph without intent evidence.
...
## Specific Checks
- Check that citation readiness decision tree is applied to the correct content unit.
- Check that the decision matches this purpose: decides which passages deserve GEO work before drafting or rewriting starts.
- Check that the output can be inspected as a yes, no, or defer decision with evidence requirements.
- Check that the risk is addressed directly: applying citation formatting to every paragraph without intent evidence.
