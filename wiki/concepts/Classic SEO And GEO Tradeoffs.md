...
## Summary
Classic SEO And GEO Tradeoffs is a planning note for dual optimization.
It documents tradeoffs between traditional ranking tactics and citation-ready structure.
Use it with [[Dual Optimization]] when the working unit is a blog program, article, or section.

## Operating Question
- What is gained or lost when a page is shaped for extraction as well as ranking?
- The expected output is a tradeoff note with recommended priority and rationale.
- The main risk is treating GEO formatting as free when it can affect reading flow.
...
## Specific Checks
- Check that classic seo and geo tradeoffs is applied to the correct content unit.
- Check that the decision matches this purpose: documents tradeoffs between traditional ranking tactics and citation-ready structure.
- Check that the output can be inspected as a tradeoff note with recommended priority and rationale.
- Check that the risk is addressed directly: treating GEO formatting as free when it can affect reading flow.
