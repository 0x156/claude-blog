...
## Summary
FLOW Brief Stage is the spoke for turn source intake and reader framing into a draftable brief.
Use it when [[FLOW Framework]] needs a repeatable decision record before a brief, draft, score, or report moves forward.
The durable output is a FLOW brief packet.
The success condition is that brief decisions remain tied to evidence and constraints.
...
- Sibling comparison starts with [[FLOW Source Intake]] and [[FLOW Draft Stage]].
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs FLOW Brief Stage.
...
- Metric set for review: brief completeness, risk notes, source attachment, and approval state.

## Operating Procedure
- Start with the precise decision that FLOW Brief Stage must make.
...
- Reject the failure pattern of using FLOW as a generic prompt without source discipline.
...
## Acceptance Criteria
- The FLOW brief packet names the exact object under review.
...
- The note accepts using FLOW as a generic prompt without source discipline.
...
- The next review should verify whether brief completeness, risk notes, source attachment, and approval state still captures the decision quality.
