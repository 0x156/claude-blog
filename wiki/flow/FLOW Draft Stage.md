...
## Summary
FLOW Draft Stage is the spoke for guide drafting while preserving claims, voice, structure, and source constraints.
Use it when [[FLOW Framework]] needs a repeatable decision record before a brief, draft, score, or report moves forward.
The durable output is a FLOW draft packet.
The success condition is that drafting expands the brief without inventing unsupported claims.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs FLOW Draft Stage.
...
- Metric set for review: claim fidelity, structure fit, voice match, and answer blocks.

## Operating Procedure
- Start with the precise decision that FLOW Draft Stage must make.
...
- Reject the failure pattern of allowing creative phrasing to change claim scope.
...
## Acceptance Criteria
- The FLOW draft packet names the exact object under review.
...
- The note accepts allowing creative phrasing to change claim scope.
...
- The next review should verify whether claim fidelity, structure fit, voice match, and answer blocks still captures the decision quality.
