...
## Summary
Answer Block Extraction Test is a citation review note for AI citation mechanics.
It tests whether a direct answer remains useful when separated from the full article.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- What happens if this block is extracted alone?
- The expected output is an extraction test with pass, revise, or reject status.
- The main risk is assuming a paragraph is citability-ready because it is concise.
...
## Specific Checks
- Check that answer block extraction test is applied to the correct content unit.
- Check that the decision matches this purpose: tests whether a direct answer remains useful when separated from the full article.
- Check that the output can be inspected as an extraction test with pass, revise, or reject status.
- Check that the risk is addressed directly: assuming a paragraph is citability-ready because it is concise.
