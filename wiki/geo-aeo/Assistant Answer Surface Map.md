...
## Summary
Assistant Answer Surface Map is a citation review note for AI citation mechanics.
It maps answer surfaces while keeping Google, assistant, and marketplace claims separate.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- Which answer surface is being optimized and measured?
- The expected output is a surface map with source posture and caveats.
- The main risk is collapsing Google AI features and independent assistants into one tactic.
...
## Specific Checks
- Check that assistant answer surface map is applied to the correct content unit.
- Check that the decision matches this purpose: maps answer surfaces while keeping Google, assistant, and marketplace claims separate.
- Check that the output can be inspected as a surface map with source posture and caveats.
- Check that the risk is addressed directly: collapsing Google AI features and independent assistants into one tactic.
