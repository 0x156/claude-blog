...
## Summary
Citation Exposure Metrics is a citation review note for AI citation mechanics.
It defines how to report AI feature impressions, cited exposure, clicks, and uncertainty.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- Which citation metrics are available, observed, or inferred?
- The expected output is a citation exposure measurement map.
- The main risk is mixing AI feature impressions with classic rankings without labels.
...
## Specific Checks
- Check that citation exposure metrics is applied to the correct content unit.
- Check that the decision matches this purpose: defines how to report AI feature impressions, cited exposure, clicks, and uncertainty.
- Check that the output can be inspected as a citation exposure measurement map.
- Check that the risk is addressed directly: mixing AI feature impressions with classic rankings without labels.
