...
## Summary
AI Feature Preview Controls is a citation review note for AI citation mechanics.
It documents preview-control choices and their possible effect on AI feature visibility.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- Do snippet or preview controls align with the visibility goal?
- The expected output is a preview-control note with tradeoffs and approval need.
- The main risk is blocking previews without acknowledging citation and snippet effects.
...
## Specific Checks
- Check that ai feature preview controls is applied to the correct content unit.
- Check that the decision matches this purpose: documents preview-control choices and their possible effect on AI feature visibility.
- Check that the output can be inspected as a preview-control note with tradeoffs and approval need.
- Check that the risk is addressed directly: blocking previews without acknowledging citation and snippet effects.
