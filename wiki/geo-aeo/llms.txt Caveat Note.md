...
## Summary
llms.txt Caveat Note is a citation review note for AI citation mechanics.
It documents why llms.txt is not a Google Search, AIO, or AI Mode requirement.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- Is llms.txt being proposed for the right reason and with the right caveat?
- The expected output is a caveat note that distinguishes Google Search from other LLM consumers.
- The main risk is selling llms.txt as a Google visibility tactic.
...
## Specific Checks
- Check that llms.txt caveat note is applied to the correct content unit.
- Check that the decision matches this purpose: documents why llms.txt is not a Google Search, AIO, or AI Mode requirement.
- Check that the output can be inspected as a caveat note that distinguishes Google Search from other LLM consumers.
- Check that the risk is addressed directly: selling llms.txt as a Google visibility tactic.
