...
## Summary
AI Overview Citation Review is a citation review note for AI citation mechanics.
It reviews sections for AI Overview exposure without promising inclusion.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- Which passages are most likely to help an AI Overview answer and why?
- The expected output is an AIO review note with evidence, confidence, and limitations.
- The main risk is calling citation readiness a guarantee of citation.
...
## Specific Checks
- Check that ai overview citation review is applied to the correct content unit.
- Check that the decision matches this purpose: reviews sections for AI Overview exposure without promising inclusion.
- Check that the output can be inspected as an AIO review note with evidence, confidence, and limitations.
- Check that the risk is addressed directly: calling citation readiness a guarantee of citation.
