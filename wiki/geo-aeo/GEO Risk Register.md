...
## Summary
GEO Risk Register is a citation review note for AI citation mechanics.
It tracks overclaims, unsupported workflow claims, measurement gaps, and policy drift.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- What could make a GEO recommendation misleading or stale?
- The expected output is a GEO risk entry with source, confidence, and refresh date.
- The main risk is turning practitioner tactics into verified guarantees.
...
## Specific Checks
- Check that geo risk register is applied to the correct content unit.
- Check that the decision matches this purpose: tracks overclaims, unsupported workflow claims, measurement gaps, and policy drift.
- Check that the output can be inspected as a GEO risk entry with source, confidence, and refresh date.
- Check that the risk is addressed directly: turning practitioner tactics into verified guarantees.
