...
## Summary
Generative Search Measurement Plan is a citation review note for AI citation mechanics.
It sets first-party measurement priorities for AI Overviews, AI Mode, and classic Search.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- How will the team measure generative search without inventing missing data?
- The expected output is a measurement plan with GSC availability and fallback context.
- The main risk is filling reporting gaps with unsupported estimates.
...
## Specific Checks
- Check that generative search measurement plan is applied to the correct content unit.
- Check that the decision matches this purpose: sets first-party measurement priorities for AI Overviews, AI Mode, and classic Search.
- Check that the output can be inspected as a measurement plan with GSC availability and fallback context.
- Check that the risk is addressed directly: filling reporting gaps with unsupported estimates.
