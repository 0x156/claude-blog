...
## Summary
Entity Clarity For AI Answers is a citation review note for AI citation mechanics.
It makes people, products, brands, dates, and concepts explicit inside answer passages.
Use it with [[AI Citation Mechanics]] when the working unit is a answer passage, AI feature exposure, or citation report.

## Operating Question
- Does the passage name the entity clearly enough for extraction?
- The expected output is an entity clarity pass with rewritten answer blocks.
- The main risk is using vague references that depend on surrounding context.
...
## Specific Checks
- Check that entity clarity for ai answers is applied to the correct content unit.
- Check that the decision matches this purpose: makes people, products, brands, dates, and concepts explicit inside answer passages.
- Check that the output can be inspected as an entity clarity pass with rewritten answer blocks.
- Check that the risk is addressed directly: using vague references that depend on surrounding context.
