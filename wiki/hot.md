...
Working cache for Claude Blog Brain. Keep this note under 500 words and overwrite it in place.
...
- QRG status is stable as of 2026-07-06: the substrate records no newer revision than 2025-09-11. See [[E-E-A-T for Blog Content]].

## Active threads

- Foundation slice creates meta notes and one hub per theme only.
- Later slices should fill spoke notes linked from the hubs.
- Keep [[Research Pack Index]] aligned with source-ledger evidence.
