...
## Summary
Cluster Performance Score is the spoke for score cluster health across coverage, quality, links, evidence, and outcomes.
...
The durable output is a cluster scorecard.
The success condition is that cluster health is measured with inspectable criteria and no traffic promise.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Cluster Performance Score.
...
- Metric set for review: coverage score, link score, quality score, citation score, and data confidence.

## Operating Procedure
- Start with the precise decision that Cluster Performance Score must make.
...
- Reject the failure pattern of turning a score into a ranking guarantee.
...
## Acceptance Criteria
- The cluster scorecard names the exact object under review.
...
- The note accepts turning a score into a ranking guarantee.
...
- The next review should verify whether coverage score, link score, quality score, citation score, and data confidence still captures the decision quality.
