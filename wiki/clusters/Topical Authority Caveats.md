...
## Summary
Topical Authority Caveats is the spoke for keep cluster language honest about topical coverage, expertise, and uncertainty.
...
The durable output is a authority caveat register.
The success condition is that the cluster can describe coverage quality without promising rankings.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Topical Authority Caveats.
...
- Metric set for review: claim confidence, source support, expert review need, and rollback notes.

## Operating Procedure
- Start with the precise decision that Topical Authority Caveats must make.
...
- Reject the failure pattern of using topical authority as a vague sales claim.
...
## Acceptance Criteria
- The authority caveat register names the exact object under review.
...
- The note accepts using topical authority as a vague sales claim.
...
- The next review should verify whether claim confidence, source support, expert review need, and rollback notes still captures the decision quality.
