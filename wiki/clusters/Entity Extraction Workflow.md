...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Entity Extraction Workflow.
...
- Metric set for review: entity coverage, missing entity evidence, and linked source coverage.

## Operating Procedure
- Start with the precise decision that Entity Extraction Workflow must make.
...
- Reject the failure pattern of confusing entity salience with a ranking guarantee.
...
## Acceptance Criteria
- The entity extraction worksheet names the exact object under review.
...
- The note accepts confusing entity salience with a ranking guarantee.
...
- The next review should verify whether entity coverage, missing entity evidence, and linked source coverage still captures the decision quality.
