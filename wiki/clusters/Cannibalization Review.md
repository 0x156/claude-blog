...
## Summary
Cannibalization Review is the spoke for find pages that compete for the same intent, entity, and conversion role.
...
The durable output is a cannibalization review sheet.
The success condition is that overlapping pages are merged, differentiated, or given clear canonical roles.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Cannibalization Review.
...
- Metric set for review: overlap count, canonical decisions, merge candidates, and monitoring notes.

## Operating Procedure
- Start with the precise decision that Cannibalization Review must make.
...
- Reject the failure pattern of assuming traffic decline means cannibalization without query and page evidence.
...
## Acceptance Criteria
- The cannibalization review sheet names the exact object under review.
...
- The note accepts assuming traffic decline means cannibalization without query and page evidence.
...
- The next review should verify whether overlap count, canonical decisions, merge candidates, and monitoring notes still captures the decision quality.
