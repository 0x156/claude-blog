...
## Summary
E-E-A-T Trust Subscore is the spoke for score experience, expertise, author transparency, source quality, and YMYL risk.
Use it when [[Blog Quality Score]] needs a repeatable decision record before a brief, draft, score, or report moves forward.
The durable output is a E-E-A-T trust subscore.
The success condition is that trust scoring makes evidence and accountability visible.
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs E-E-A-T Trust Subscore.
...
- Metric set for review: experience signal, expert review need, source trust, and YMYL flag.

## Operating Procedure
- Start with the precise decision that E-E-A-T Trust Subscore must make.
...
- Reject the failure pattern of checking author names while ignoring source quality and reputation.
...
## Acceptance Criteria
- The E-E-A-T trust subscore names the exact object under review.
...
- The note accepts checking author names while ignoring source quality and reputation.
...
- The next review should verify whether experience signal, expert review need, source trust, and YMYL flag still captures the decision quality.
