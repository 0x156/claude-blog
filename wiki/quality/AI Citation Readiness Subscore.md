...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs AI Citation Readiness Subscore.
...
- Metric set for review: answer block score, entity score, citation clarity, and AI caveat status.

## Operating Procedure
- Start with the precise decision that AI Citation Readiness Subscore must make.
...
- Reject the failure pattern of claiming llms.txt or special AI schema is required by Google.
...
## Acceptance Criteria
- The AI citation readiness subscore names the exact object under review.
...
- The note accepts claiming llms.txt or special AI schema is required by Google.
...
- The next review should verify whether answer block score, entity score, citation clarity, and AI caveat status still captures the decision quality.
