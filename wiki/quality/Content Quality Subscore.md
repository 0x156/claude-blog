...
## Summary
Content Quality Subscore is the spoke for score originality, completeness, usefulness, structure, and source-backed clarity.
Use it when [[Blog Quality Score]] needs a repeatable decision record before a brief, draft, score, or report moves forward.
The durable output is a content quality subscore.
The success condition is that content earns points for reader satisfaction and original value.
...
- Sibling comparison starts with [[Quality Score Rubric]] and [[SEO Intent Subscore]].
...
## Required Inputs
- Target topic, article, cluster, or workflow item that needs Content Quality Subscore.
...
- Metric set for review: usefulness score, originality score, answer coverage, and source coverage.

## Operating Procedure
- Start with the precise decision that Content Quality Subscore must make.
...
- Reject the failure pattern of rewarding word count without reader value.
...
## Acceptance Criteria
- The content quality subscore names the exact object under review.
...
- The note accepts rewarding word count without reader value.
...
- The next review should verify whether usefulness score, originality score, answer coverage, and source coverage still captures the decision quality.
