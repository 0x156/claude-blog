...
## Summary
This spoke routes sensitive local advice to expert review before publication.
...
Primary working inputs: YMYL topic flag, jurisdiction, source list, reviewer requirement.
...
## Workflow
- Define the decision this note supports: routes sensitive local advice to expert review before publication.
...
## Risk Controls
- Evidence currency risk: Regional Legal And YMYL Escalation decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Regional Legal And YMYL Escalation advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Regional Legal And YMYL Escalation into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Regional Legal And YMYL Escalation guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Regional Legal And YMYL Escalation outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Regional Legal And YMYL Escalation decision summary for the editor or auditor.
...
- A blocked-claims list for Regional Legal And YMYL Escalation gaps that need more evidence.
...
- A no-action statement when Regional Legal And YMYL Escalation evidence is incomplete or outside this brain.
