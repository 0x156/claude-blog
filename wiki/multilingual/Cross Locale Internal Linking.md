...
## Summary
This spoke keeps internal links useful within each language while preserving cluster relationships across locales.
...
Primary working inputs: hub map, local spokes, alternate links, translated anchors.
...
## Workflow
- Define the decision this note supports: keeps internal links useful within each language while preserving cluster relationships across locales.
...
## Risk Controls
- Evidence currency risk: Cross Locale Internal Linking decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Cross Locale Internal Linking advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Cross Locale Internal Linking into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Cross Locale Internal Linking guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Cross Locale Internal Linking outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Cross Locale Internal Linking decision summary for the editor or auditor.
...
- A blocked-claims list for Cross Locale Internal Linking gaps that need more evidence.
...
- A no-action statement when Cross Locale Internal Linking evidence is incomplete or outside this brain.
