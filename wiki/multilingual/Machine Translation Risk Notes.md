...
## Summary
This spoke marks the quality, spam, and trust risks of publishing machine translation without added local value.
...
Primary working inputs: machine translation output, editor changes, local value additions, risk notes.
...
## Workflow
- Define the decision this note supports: marks the quality, spam, and trust risks of publishing machine translation without added local value.
...
## Risk Controls
- Evidence currency risk: Machine Translation Risk Notes decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Machine Translation Risk Notes advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Machine Translation Risk Notes into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Machine Translation Risk Notes guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Machine Translation Risk Notes outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Machine Translation Risk Notes decision summary for the editor or auditor.
...
- A blocked-claims list for Machine Translation Risk Notes gaps that need more evidence.
...
- A no-action statement when Machine Translation Risk Notes evidence is incomplete or outside this brain.
