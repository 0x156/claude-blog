...
## Summary
This spoke separates literal language transfer from local market adaptation.
...
Primary working inputs: translation draft, local examples, locale reviewer notes, claim inventory.
...
## Workflow
- Define the decision this note supports: separates literal language transfer from local market adaptation.
...
## Risk Controls
- Evidence currency risk: Translation Versus Localization decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Translation Versus Localization advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Translation Versus Localization into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Translation Versus Localization guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Translation Versus Localization outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Translation Versus Localization decision summary for the editor or auditor.
...
- A blocked-claims list for Translation Versus Localization gaps that need more evidence.
...
- A no-action statement when Translation Versus Localization evidence is incomplete or outside this brain.
