...
## Summary
Experience Evidence Checklist is a trust review note for E-E-A-T review.
It lists the field, product, process, or client evidence that makes experience inspectable.
Use it with [[E-E-A-T for Blog Content]] when the working unit is a author, page, source set, or editorial process.

## Operating Question
- Where can the reader see lived or operational experience on the page?
- The expected output is an experience checklist with visible placements.
- The main risk is claiming experience without examples, data, or observations.
...
## Specific Checks
- Check that experience evidence checklist is applied to the correct content unit.
- Check that the decision matches this purpose: lists the field, product, process, or client evidence that makes experience inspectable.
- Check that the output can be inspected as an experience checklist with visible placements.
- Check that the risk is addressed directly: claiming experience without examples, data, or observations.
