...
## Summary
YMYL Escalation Matrix is a trust review note for E-E-A-T review.
It routes sensitive money, health, safety, civic, and legal-adjacent content to stronger review.
Use it with [[E-E-A-T for Blog Content]] when the working unit is a author, page, source set, or editorial process.

## Operating Question
- Does this article create material risk for a reader decision?
- The expected output is an escalation matrix with review, sourcing, and limitation requirements.
- The main risk is treating YMYL risk as a keyword category only.
...
## Specific Checks
- Check that ymyl escalation matrix is applied to the correct content unit.
- Check that the decision matches this purpose: routes sensitive money, health, safety, civic, and legal-adjacent content to stronger review.
- Check that the output can be inspected as an escalation matrix with review, sourcing, and limitation requirements.
- Check that the risk is addressed directly: treating YMYL risk as a keyword category only.
