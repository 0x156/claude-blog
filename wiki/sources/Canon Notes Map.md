...
## Summary
This spoke maps canon notes to the guidance areas they support so writers choose primary sources first.
...
Primary working inputs: canon note, URL, topic, workflow route.
...
## Workflow
- Define the decision this note supports: maps canon notes to the guidance areas they support so writers choose primary sources first.
...
## Risk Controls
- Evidence currency risk: Canon Notes Map decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Canon Notes Map advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Canon Notes Map into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Canon Notes Map guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Canon Notes Map outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Canon Notes Map decision summary for the editor or auditor.
...
- A blocked-claims list for Canon Notes Map gaps that need more evidence.
...
- A no-action statement when Canon Notes Map evidence is incomplete or outside this brain.
