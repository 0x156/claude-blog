...
## Summary
This spoke joins update dates to first-party page performance and source refresh needs.
...
Primary working inputs: date window, page set, GSC export, GA4 export, editorial notes.
...
## Workflow
- Define the decision this note supports: joins update dates to first-party page performance and source refresh needs.
...
## Risk Controls
- Evidence currency risk: Update Impact Review decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Update Impact Review advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Update Impact Review into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Update Impact Review guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Update Impact Review outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Update Impact Review decision summary for the editor or auditor.
...
- A blocked-claims list for Update Impact Review gaps that need more evidence.
...
- A no-action statement when Update Impact Review evidence is incomplete or outside this brain.
