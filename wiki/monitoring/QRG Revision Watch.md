...
## Summary
This spoke tracks Search Quality Rater Guideline revisions and maps changes to quality checks.
...
Primary working inputs: QRG URL, revision date, change summary, affected audits.
...
## Workflow
- Define the decision this note supports: tracks Search Quality Rater Guideline revisions and maps changes to quality checks.
...
## Risk Controls
- Evidence currency risk: QRG Revision Watch decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep QRG Revision Watch advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn QRG Revision Watch into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust QRG Revision Watch guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in QRG Revision Watch outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A QRG Revision Watch decision summary for the editor or auditor.
...
- A blocked-claims list for QRG Revision Watch gaps that need more evidence.
...
- A no-action statement when QRG Revision Watch evidence is incomplete or outside this brain.
