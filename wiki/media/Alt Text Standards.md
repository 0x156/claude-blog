...
## Summary
This spoke sets useful alt text rules for informational images, decorative images, screenshots, charts, and product visuals.
...
Primary working inputs: image list, visual purpose, surrounding copy, accessibility notes.
...
## Workflow
- Define the decision this note supports: sets useful alt text rules for informational images, decorative images, screenshots, charts, and product visuals.
...
## Risk Controls
- Evidence currency risk: Alt Text Standards decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Alt Text Standards advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Alt Text Standards into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Alt Text Standards guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Alt Text Standards outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Alt Text Standards decision summary for the editor or auditor.
...
- A blocked-claims list for Alt Text Standards gaps that need more evidence.
...
- A no-action statement when Alt Text Standards evidence is incomplete or outside this brain.
