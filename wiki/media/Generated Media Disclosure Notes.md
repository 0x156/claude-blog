...
## Summary
This spoke records when generated or edited media needs disclosure, review, or replacement with primary visuals.
...
Primary working inputs: prompt, source references, review status, risk notes.
...
## Workflow
- Define the decision this note supports: records when generated or edited media needs disclosure, review, or replacement with primary visuals.
...
## Risk Controls
- Evidence currency risk: Generated Media Disclosure Notes decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Generated Media Disclosure Notes advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Generated Media Disclosure Notes into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Generated Media Disclosure Notes guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Generated Media Disclosure Notes outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Generated Media Disclosure Notes decision summary for the editor or auditor.
...
- A blocked-claims list for Generated Media Disclosure Notes gaps that need more evidence.
...
- A no-action statement when Generated Media Disclosure Notes evidence is incomplete or outside this brain.
