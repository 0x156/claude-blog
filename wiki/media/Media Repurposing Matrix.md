...
## Summary
This spoke maps one blog asset into social, email, video, chart, and slide variants without widening claims.
...
Primary working inputs: source post, asset list, channels, claim guardrails.
...
## Workflow
- Define the decision this note supports: maps one blog asset into social, email, video, chart, and slide variants without widening claims.
...
## Risk Controls
- Evidence currency risk: Media Repurposing Matrix decisions can go stale when a source, date, or requirement changes.
- Claim scope risk: keep Media Repurposing Matrix advice tied to the source coverage named in this note.
- Operational boundary risk: do not turn Media Repurposing Matrix into CMS, analytics, Search Console, API, or publishing mutation steps.
- Proof gap risk: when the note lacks direct evidence, record the gap instead of upgrading confidence.
- Audience fit risk: adjust Media Repurposing Matrix guidance for topic sensitivity, locale, and review ownership before use.
- Media and data risk: verify charts, visuals, metrics, and examples before they carry this note's claims.
- Metric interpretation risk: separate first-party exports, market studies, and API signals in Media Repurposing Matrix outputs.
- Monitoring risk: quarantine unconfirmed volatility until a dated source in the ledger supports it.

## Output Shape
- A Media Repurposing Matrix decision summary for the editor or auditor.
...
- A blocked-claims list for Media Repurposing Matrix gaps that need more evidence.
...
- A no-action statement when Media Repurposing Matrix evidence is incomplete or outside this brain.
